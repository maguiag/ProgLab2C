...
//    float bufferFloat;                                          //cambiar buffer varFloat
    ...
    if(array!=NULL && size>=0)
    {
        for (i = 1; i < size; i++)
        {
            ...
            bufferId=array[i].idSocios;                                   //cambiar campo id
...
//            bufferFloat=array[i].varFloat;                            //cambiar campo varFloat
            ...
            {                                                                                                               //buffer < campo ascendente   buffer > campo descendente
                ...
                array[j + 1].idSocios=array[j].idSocios;                                //cambiar campo id
...
//                array[j + 1].varFloat=array[j].varFloat;                    //cambiar campo varFloat
            ...
            array[j + 1].idSocios=bufferId;                                        //cambiar campo id
...
//            else
//                printf("\n ID: %d\n varInt: %d\n varFloat: %f\n nombre: %s\n apellido: %s",
//                       array[i].idSocios,array[i].varInt,array[i].varFloat,array[i].nombre,array[i].apellido);      //cambiar todos
        }
        retorno=0;
    }
    return retorno;
