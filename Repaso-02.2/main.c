...
#define CHARLEN 51   // largo de mail
...
int main()
{
    ...
    char mailAuxiliar[CHARLEN];
    int primerIndiceLibre =50;// primero libre xq ya cargue 50 mails
    int i;
    ...
    for(i=0; i<primerIndiceLibre; i++)//itero array de string mail, desde el primero hasta el ultimo
    {
        printf("\n%s",mails[i]);
    }
